"""
Code is copied and adapted from https://github.com/afogarty85/fooddata_central/blob/main/main.py
"""
...
def nutrition_retrieval(food_list, fdcIDs, api_key=api_key):
    ...
    for num, i in enumerate(fdcIDs):
        ...
        # append data
        nutrient_container.append([food_list[num], parsed['ingredients'], 
        trans_fat, sat_fat, cholesterol,
